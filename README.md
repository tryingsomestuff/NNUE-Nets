...
- **nettling nemesis** for Minic 3.02 (12/2020): this net is built using 2B Stockfish (master) data at depth d5. This one is **not** for use in rating list of course ! just for fun. Minic is of course a lot stronger using this net. Architecture is the same as previous net.
